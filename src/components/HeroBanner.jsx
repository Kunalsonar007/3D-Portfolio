...
import man from "../assets/kunal.png";
  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="text-[80px] font-light">70+</div>
        ...
        >
          ...
          >
            ...
            <div className="text-black">
              <a href="https://drive.google.com/file/d/1A1iih_eN3sn5cHfPCTwpm-8knR168CbI/view?usp=sharing" target="_blank" download="resume.pdf">
                Resume
              </a>
            </div>
          </div>
      ...
      <div style={socialIconsStyle}>
        <a href="https://www.linkedin.com/in/krazyykunal/" style={iconStyle}>
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/Kunalsonar007/" style={iconStyle}>
          <i className="fab fa-github"></i>
        </a>
        <a href="https://www.instagram.com/krazyykunal/" style={iconStyle}>
